...
class TestEquilibriumIntegration:
    ...
    def test_solver_with_diagnostics(self):
        ...
        prices, z_norm, walras_dot, status, diagnostics = (
            solve_equilibrium_with_diagnostics([agent1, agent2])
        )
    ...
    def test_fallback_behavior(self):
        ...
        prices, z_norm, walras_dot, status = solve_equilibrium_enhanced(
            [agent1, agent2], use_robust_solver=True, fallback_to_original=True
        )
    ...
    def test_no_fallback_behavior(self):
        ...
        prices, z_norm, walras_dot, status = solve_equilibrium_enhanced(
            [agent1, agent2], use_robust_solver=True, fallback_to_original=False
        )
